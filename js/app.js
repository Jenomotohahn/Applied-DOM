(function(window) {
   ...
   */
    ...
    const setMyLightGreen = function() {
      ...
      const getEl = document.getElementById(lightId);
      getEl.className = 'light-green';
    };
   ...
   */
   ...
   btn3.addEventListener('click', setMyLightGreen);
      // setMyLightGreen();
      // let newFunc = setMyLightGreen.bind(this);
      // newFunc();
   ...
   *     null, 'light-green'
   */
   let setLight11Green = setMyLightClass.bind(btn11, null, 'light-green');
  /*
  ...
  const btnLight15 = setMyLightClass.bind(btn15, null, 'light-green');

  btn15.addEventListener('click', btnLight15);
